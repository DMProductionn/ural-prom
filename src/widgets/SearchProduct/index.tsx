    ...
    <>
      ...
      <div
        ...
        {product.length === 0 && searchValue && succes && isFocused ? (
          <div
            className={`${style.dropdown} bg-[#284185] text-white pl-[10px] text-[13px] h-[30px] flex items-center`}>
            <p>Нет результатов</p>
          </div>
        ) : (
          ...
          product.map((product) => (
            <div
              ...
              key={product.name}
              className={`${style.dropdown_product} bg-[#284185] hover:bg-blue transition overflow-hidden cursor-pointer max-w-[400px] w-full h-[60px] text-white pl-[10px] flex items-center gap-[40px]`}>
